<template>
  <div class="container mx-auto p-4">
    ...
    <div class="text-center font-semibold mb-4">
      STUDENT PERFORMANCE, class date between {{ formattedFromDate }} until {{ formattedToDate }}
    </div>
    ...
    <table class="table-auto w-full border border-gray-300 mb-4">
      ...
      <tbody>
        <tr v-for="(module, index) in paginatedData" :key="module.code" class="border-b">
          ...
          <td class="p-2 text-center">{{ module.date }}</td>
          <td class="p-2">{{ module.title }}</td>
          <td class="p-2">{{ module.instructor }}</td>
...
// Sample Data - Courses with Malay Instructor Names
const modules = ref([
  { code: 'ITS101', date: '2024-01-15', title: 'Introduction to Information Technology', instructor: 'Dr. Ahmad Faiz', totalStudents: 120, excellent: 15, veryGood: 30, good: 45, average: 20, bad: 10 },
  { code: 'ENG201', date: '2024-02-20', title: 'Academic English', instructor: 'Puan Siti Nur', totalStudents: 100, excellent: 10, veryGood: 25, good: 30, average: 20, bad: 15 },
  { code: 'BMK301', date: '2024-03-10', title: 'Basic Marketing Principles', instructor: 'Prof. Razali Mohd', totalStudents: 85, excellent: 20, veryGood: 25, good: 25, average: 10, bad: 5 },
  { code: 'MAT102', date: '2024-04-12', title: 'Calculus I', instructor: 'Dr. Nor Aini', totalStudents: 95, excellent: 25, veryGood: 20, good: 30, average: 15, bad: 5 },
  { code: 'CMP202', date: '2024-05-25', title: 'Computer Programming II', instructor: 'Encik Syed Ali', totalStudents: 110, excellent: 18, veryGood: 28, good: 35, average: 15, bad: 14 }
])
