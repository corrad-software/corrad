<template>
  <div class="container mx-auto p-4">
    ...
    <!-- Table Listing PPK Assessments -->
    <rs-card class="mt-4 py-2">
      <h2 class="text-xl font-semibold mb-4">PPK Assessment</h2>
...
// Sample data for PPK assessments
const tableData = ref([
  {
...
// Navigate to the PPK assessment staff details page
const navigateToAssessment = () => {
  navigateTo("/PPKAssessmentStaff");
};
</script>
