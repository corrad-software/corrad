    ...
    <table class="table-auto w-full border border-gray-300 mb-4">
      ...
      <tbody>
        ...
        >
          ...
          <td class="p-2 text-center">
            <button @click="viewDetail(staff.staffNo)" class="btn-detail">
              Detail
            </button>
          </td>
        </tr>
...
const staffList = ref([
  ...
  },
  {
    ...
    assignmentId: "A/24-8/0001",
    photo: "#",
  },
  {
    staffNo: 3823,
    fullName: "Munirah binti Abdullah",
    email: "muni@uum.edu.my",
    designation: "Pen. Peg. Teknologi Maklumat (TBK) (FA32)",
    department: "UUM Information Technology",
    assignmentId: "A/24-8/0008",
    photo: "#",
  },
  {
    staffNo: 3145,
    fullName: "Wan Siti Aishah binti Wan Abdullah",
    email: "wan.aishah@uum.edu.my",
  ...
  {
    staffNo: 4912,
    fullName: "Ahmad Syahir bin Ahmad Tarmizi",
    email: "syahir@uum.edu.my",
    designation: "Pensyarah Universiti (DS51)",
    department: "Perakaunan",
    assignmentId: "A/24-10/0055",
    photo: "#",
  },
  {
    staffNo: 1642,
    fullName: "Syafiqah binti Azman",
    email: "syafiqah@uum.edu.my",
    designation: "Pensyarah Universiti (DS54)",
    department: "Sains Sosial",
    assignmentId: "A/24-9/0039",
    photo: "#",
  },
  {
    staffNo: 2457,
    fullName: "Rafiq bin Rahman",
    email: "rafiq@uum.edu.my",
    designation: "Pensyarah Universiti (DS45)",
    department: "Pengajian Antarabangsa",
    assignmentId: "A/24-8/0012",
    photo: "#",
  },
]);
