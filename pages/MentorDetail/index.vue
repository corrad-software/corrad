<template>
  <div>
    ...
    <div class="flex items-center justify-center mb-6">
      <div class="flex-1">
        <p><strong>Staff ID:</strong> 1777</p>
        <p><strong>Staff Name:</strong> Sazali bin Saad</p>
        <p><strong>Email:</strong> sazali@uum.edu.my</p>
        <p><strong>Designation:</strong> Pensyarah Universiti (DS52)</p>
        <p><strong>Department:</strong> Perakaunan Tunku Puteri Intan Safinaz</p>
      </div>
      <div class="ml-4">
        <!-- Staff Photo -->
        <img
