<template>
  <div>
    ...
    <div class="flex items-center justify-center mb-6">
      <div class="flex-1">
        <p><strong>Staff ID:</strong> 1043</p>
        <p><strong>Staff Name:</strong> Mohd Tarmizi B Musa</p>
        <p><strong>Email:</strong> tarmizi@uum.edu.my</p>
        <p><strong>Designation:</strong> Pensyarah Universiti (DS52)</p>
        <p><strong>Department:</strong> Pengkomputeran</p>
      </div>
      <div class="ml-4">
        <!-- Staff Photo -->
        <img
