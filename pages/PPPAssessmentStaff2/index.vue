<template>
  <div>
    ...
    <!-- Table listing staff members for the assessment -->
...
// Navigate to details page for a specific record
const viewDetails = (record) => {
  navigateTo(`/PPPAssessmentStaff2Detail?staffNo=${record.staffNo}`);
};
</script>
