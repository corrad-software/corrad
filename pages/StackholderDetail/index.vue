<template>
  <div>
    ...
    <div class="flex items-center justify-center mb-6">
      <div class="flex-1">
        <p><strong>Staff ID:</strong> 2336</p>
        <p><strong>Staff Name:</strong> Mohammad Badri Bin Rozali @ Abd. Hamid</p>
        <p><strong>Email:</strong> badri@uum.edu.my</p>
        <p><strong>Designation:</strong> Pensyarah Universiti (DS45)</p>
        <p><strong>Department:</strong> Ekonomi, Kewangan dan Perbankan</p>
      </div>
      <div class="ml-4">
        <!-- Staff Photo -->
        <img
